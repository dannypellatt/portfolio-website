        ...
        <div className="carousel carousel-center max-w-full mx-auto space-x-4 rounded-box mt-8">
          <div id='slide1' className="carousel-item w-full bg-base-300">
            <div className="card w-full bg-base-300">
              <figure>
                <img src="/banjoAndMeCoding.JPG" alt="Coding with my dog" className="w-full h-auto" />
              </figure>
          ...
          <div id='slide2' className="carousel-item w-full">
            <div className="card w-full bg-base-300 shadow-xl">
              <figure>
                <img src="/gradphoto.jpeg" alt="Graduation photo" className="w-full h-auto" />
              </figure>
              <div className="p-4 sm:card-body">
          ...
          <div id='slide3' className="carousel-item w-full">
            <div className="card w-full bg-base-300">
              <figure><img src="/MeMusic.jpg" alt="Playing music" className="w-full h-auto" /></figure>
              <div className="p-4 sm:card-body">
          ...
          <div id='slide4' className="carousel-item w-full">
            <div className="card w-full bg-base-300 shadow-xl">
              <figure><img src="/movingToAmerica.jpeg" alt="Moving to America" className="w-full h-auto" /></figure>
              <div className="p-4 sm:card-body">
          ...
          <div id='slide5' className="carousel-item w-full">
            <div className="card w-full bg-base-300 shadow-xl">
              <figure><img src="/gandalf.jpeg" alt="Gandalf" className="w-full h-auto" /></figure>
              <div className="p-4 sm:card-body">
          ...
          <div id='slide6' className="carousel-item w-full">
            <div className="card w-full bg-base-300 shadow-xl">
              <figure><img src="/MeComputer.JPG" alt="Me at a Computer" className="w-full h-auto" /></figure>
              <div className="p-4 sm:card-body">
      ...
      <div className="col-span-1">
        ...
        <div className="modal" role="dialog">
          <div className="modal-box">
            <img src="/banjoAndMeCoding.JPG" alt="Coding with my dog on my lap" />
          </div>
